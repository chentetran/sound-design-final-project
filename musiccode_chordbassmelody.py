# -*- coding: utf-8 -*-
"""MusicCode_ChordBassMelody.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1J1S5zWCRVLesUS0bHJFMG7pmFvFuyw2U
"""
...
*   FinalChArray: List of Chords, with each chord being a list of its notes
*   FinalRhChArray: Duration of each chord, for now just 4 beats each  

Intermediate elements are:

*   FullChArray: Same as FinalChArray but with general string note names instead of integer pitch names
...
"""**From a list of chord names to a list of list of note names :**

ChArray becomes FullChArray
"""
...
"""**From FinalChArray with string name notes to FinalChPitchArray with pitch numbers:**

FullChArray becomes FinalChArray

*This has the benefit to naturally invert some chords, so chord the progression sounds less robotic.*
"""
...
*   FinalBassNoteArray: list of bass notes
*   FinalBassRhArray: list of rhythm of bass notes
